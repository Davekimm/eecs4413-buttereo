...
/**
 * Detailed rule class for Specification for a query. Separating this from Services.
 */
public final class ProductSpecifications {
     ...
     * @return Specification for category match
     */
     ...
     * @return Specification for keyword match
     */
